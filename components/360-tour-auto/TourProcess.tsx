const steps = [
    {
        ...
        text: 'Расскажите про шоурум — согласуем какие авто и зоны снимаем.',
    },
    {
        number: '02',
        title: 'Съёмка (до открытия или в тихие часы)',
        text: 'Снимаем шоурум и автомобили, 2–3 часа на объекте.',
    },
    {
        number: '03',
        title: 'Обработка и сборка тура',
        text: 'Собираем интерактивный маршрут по салону — 3–5 рабочих дней.',
    },
    {
        number: '04',
        title: 'Передача',
        text: 'Ссылка, iframe-код и инструкция по размещению на сайте.',
    },
];
