const plans = [
    {
        title: 'БАЗОВЫЙ',
        price: 'от 1 000 ₾',
        features: ['небольшой шоурум', 'до 5 автомобилей', 'ссылка на тур', '3–5 дней'],
        featured: false,
    },
    {
        title: 'СТАНДАРТ',
        price: 'от 1 600 ₾',
        features: ['средний дилерский центр', 'до 12 автомобилей + зоны', 'ссылка + iframe', 'логотип в туре', '3–5 дней'],
        featured: true,
    },
    {
        title: 'КОМПЛЕКСНЫЙ',
        price: 'от 2 500 ₾',
        features: ['крупный салон / несколько зон', 'без ограничений по авто', 'встройка + логотип + контакты', 'интерьер и экстерьер каждой машины', 'приоритет'],
        featured: false,
    },
];
    ...
    return (
        <section className="py-24 bg-[#080808] border-b border-[#2a2a2a]" id="pricing">
            <div className="container mx-auto px-6">
                <h2 className="text-3xl font-bold mb-10 text-white">Стоимость 360° тура для автосалона</h2>
                ...
                <p className="text-center text-sm text-white/50 mt-8">
                    Все цены в лари (₾). Для регулярного обновления тура при смене модельного ряда — по договорённости.
                </p>
            </div>
        </section>
    );
