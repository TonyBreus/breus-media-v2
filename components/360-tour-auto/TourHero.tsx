    ...
    return (
        <section id="tour-hero" className="relative pt-40 md:pt-44 pb-28 min-h-[calc(100vh-80px)] bg-[#080808] border-b border-[#2a2a2a]">
            <div className="container mx-auto px-6">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[0.95] mb-6">360° тур для автосалонов и шоурумов</h1>
                <p className="text-base md:text-xl text-white/75 max-w-3xl leading-relaxed">
                    Покупатель осматривает автомобиль снаружи и внутри дистанционно — до поездки в дилерский центр. Это
                    помогает в Тбилиси сократить пустые визиты и быстрее закрывать сделки с удалёнными покупателями.
                </p>
                <p className="text-sm text-white/65 max-w-3xl leading-relaxed mt-4">
                    Особенно востребовано для премиум-сегмента и покупателей из других городов и стран — тур заменяет
                    первый визит на осмотр.
                </p>
                <p className="text-xs text-white/50 max-w-3xl leading-relaxed mt-3">
                    Работаем с автосалонами в Тбилиси. Другие города Грузии — по договорённости.
                </p>
