...
const relatedServices = [
    {
        ...
        text: 'Интерактивный формат для презентации номеров и инфраструктуры.',
    },
    {
    ...
    },
    {
        ...
        text: 'Презентация коммерческих пространств для B2B-аудитории.',
    },
    {
        title: '360° тур для недвижимости',
        href: '/360-tour-real-estate',
        text: 'Сценарии удалённого просмотра объектов и пространств.',
    },
];
