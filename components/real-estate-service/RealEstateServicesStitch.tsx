...
export const RealEstateServicesStitch = () => {
    const services = [...realEstateServiceItems].sort((a, b) => (a.order ?? a.id) - (b.order ?? b.id));

    return (
        <DebugWrapper id={10300} label="Real Estate Services Section">
            <section className="py-24 bg-[#080808]" id="services">
                ...
                <div className="container mx-auto px-6">
                    <DebugWrapper id={10301} label="Services Header">
                        <div className="mb-16">
                            <h2 className="text-3xl font-bold mb-4 text-white">Направления для недвижимости</h2>
