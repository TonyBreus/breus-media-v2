...
type RealEstateHeroStitchProps = {
    hero: DroneDirectionHeroConfig;
};

const ROTATION_MS = 5000;

export const RealEstateHeroStitch = ({ hero }: RealEstateHeroStitchProps) => {
    const heroServices = useMemo(
        () => [...realEstateServiceItems].sort((a, b) => (a.order ?? a.id) - (b.order ?? b.id)),
        []
    );
