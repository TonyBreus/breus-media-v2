const plans = [
    {
        title: 'БАЗОВЫЙ',
        price: 'от 900 ₾',
        features: ['до 80 м² / основной зал', 'до 6 точек съёмки', 'ссылка на тур', '3-5 дней'],
        featured: false,
    },
    {
        title: 'СТАНДАРТ',
    ...
    },
    {
        title: 'КОМПЛЕКСНЫЙ',
        price: 'от 2 200 ₾',
        features: ['любой размер', 'все зоны включая терассу', 'встройка + логотип + контакты', 'приоритет', 'мобильная оптимизация'],
        featured: false,
    },
];
    ...
    return (
        <section className="py-24 bg-[#080808] border-b border-[#2a2a2a]" id="pricing">
            <div className="container mx-auto px-6">
                <h2 className="text-3xl font-bold mb-10 text-white">Стоимость 360° тура для ресторана</h2>
                ...
                <p className="text-center text-sm text-white/50 mt-8">
                    Все цены в лари (₾). Пакет для нескольких заведений - по договорённости.
                </p>
            </div>
        </section>
    );
