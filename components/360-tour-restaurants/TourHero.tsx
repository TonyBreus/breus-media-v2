    ...
    return (
        <section id="tour-hero" className="relative pt-40 md:pt-44 pb-28 min-h-[calc(100vh-80px)] bg-[#080808] border-b border-[#2a2a2a]">
            <div className="container mx-auto px-6">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[0.95] mb-6">360° тур для ресторанов и кафе</h1>
                <p className="text-base md:text-xl text-white/75 max-w-3xl leading-relaxed">
                    Гость видит атмосферу, выбирает столик и понимает формат заведения - до того как пришёл. Это помогает в
                    Тбилиси привлекать туристов и закрывать банкеты дистанционно.
                </p>
                <p className="text-sm text-white/65 max-w-3xl leading-relaxed mt-4">
                    Особенно востребовано для туристов и иностранцев, которые выбирают заведение онлайн - через Instagram,
                    Google Maps или по рекомендации.
                </p>
                <p className="text-xs text-white/50 max-w-3xl leading-relaxed mt-3">
                    Работаем с ресторанами в Тбилиси: Руставели, Мтацминда, Вера, Сабуртало. Другие города Грузии - по
                    договорённости.
                </p>
