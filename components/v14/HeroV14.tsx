...
export default function HeroV14() {
    ...
    return (
        <section className="relative h-screen min-h-[800px] w-full overflow-hidden flex flex-col justify-center bg-[#0a0a0a]">
            ...
            {/* 2. MAIN CONTENT (Pushed content up to start higher) */}
            <div className="relative z-10 container mx-auto px-6 flex flex-col items-center text-center mt-24">

                {/* Badge (Moved Higher + Spacing) */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.1 }}
                    className="mb-16" // Increased margin-bottom to separate from headline
                >
            ...
            {/* 3. INTERACTIVE TICKERS (Placed higher to ensure visibility) */}
