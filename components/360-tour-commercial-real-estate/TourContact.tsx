...
export function TourContact() {
    ...
    const methodLabels: Record<'Telegram' | 'WhatsApp' | 'Email', string> = {
        Telegram: 'Телеграм',
        WhatsApp: 'Вотсап',
        Email: 'Почта',
    };
    ...
    const serviceOptions = [
        '360° тур коммерческого объекта',
        'Встраивание на сайт и в объявления',
        'Материалы для брокеров',
        'Контент для продвижения объекта',
        'Съёмка многозонального пространства',
    ];
    ...
    const contactPlaceholder = method === 'Email' ? 'name@company.com' : method === 'WhatsApp' ? '+995 ...' : '@логин';
        ...
        <section className="py-20 bg-[#080808]" id="contact">
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto rounded-2xl border border-[#D4A017]/35 bg-gradient-to-br from-[#141414] via-[#111111] to-[#0d0d0d] p-6 md:p-8">
                    <h2 className="text-3xl font-bold mb-3 text-white">Обсудим ваш объект коммерческой недвижимости</h2>
                    <p className="text-white/70 mb-8 max-w-2xl leading-relaxed">
                        Оставьте задачу и контакты. Подберём формат съёмки и упаковки под аренду, продажу и удалённые показы.
                    </p>
                    ...
                    <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div>
                            ...
                            <textarea
                                rows={3}
                                placeholder="Тип объекта, площадь, количество зон, сроки и где планируете размещать тур"
