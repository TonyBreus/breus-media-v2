const beginnerFaq = [
    {
        question: 'Что такое 360° тур для коммерческого помещения?',
        answer: 'Это интерактивный формат, в котором клиент может осмотреть объект онлайн до личного просмотра.',
    },
    {
        question: 'Это видео или интерактивный просмотр?',
        answer: 'Это интерактивный просмотр: клиент сам выбирает направление, ракурс и переходы между зонами.',
    },
    {
        question: 'Можно ли смотреть с телефона?',
        answer: 'Да, тур открывается в браузере на телефоне, планшете и компьютере.',
    },
    {
        question: 'Нужно ли устанавливать приложение?',
        answer: 'Нет, обычно ничего устанавливать не нужно. Достаточно открыть ссылку.',
    },
    {
        question: 'Где можно разместить такой тур?',
        answer: 'На сайте, в объявлениях, в презентациях, в мессенджерах и в материалах для брокеров.',
    },
];
