...
export default function HeroV22() {
    ...
    return (
        <section className="relative pt-[220px] pb-0 bg-black overflow-hidden min-h-[90vh] flex flex-col justify-center text-center">
            ...
            {/* SMOOTH GRADIENT TRANSITION (TO #0F0F0F) */}
            {/* Uses a specific color blend to match PainBlock's dark gray/red bg */}
            <div className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-[#0F0F0F] via-black/90 to-transparent pointer-events-none z-0" />
