    ...
    return (
        <section id="tour-hero" className="relative pt-40 md:pt-44 pb-28 min-h-[calc(100vh-80px)] bg-[#080808] border-b border-[#2a2a2a]">
            <div className="container mx-auto px-6">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[0.95] mb-6">360° тур для клиник и стоматологий</h1>
                <p className="text-base md:text-xl text-white/75 max-w-3xl leading-relaxed">
                    Пациент видит вашу клинику, оборудование и атмосферу до записи на приём. Это снижает тревожность и
                    помогает иностранным пациентам выбирать вас дистанционно.
                </p>
                <p className="text-sm text-white/65 max-w-3xl leading-relaxed mt-4">
                    Особенно востребовано для медицинского туризма — пациенты из России, Европы и стран СНГ выбирают
                    клинику в Тбилиси онлайн, без возможности приехать заранее.
                </p>
                <p className="text-xs text-white/50 max-w-3xl leading-relaxed mt-3">
                    Работаем с клиниками в Тбилиси. Другие города Грузии — по договорённости.
                </p>
