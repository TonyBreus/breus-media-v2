const steps = [
    {
        ...
        text: 'Обсуждаем формат клиники, нужные зоны и цели размещения тура.',
    },
    {
        number: '02',
        title: 'Съёмка (до открытия или между приёмами)',
        text: 'Снимаем ключевые зоны клиники за 1-3 часа без остановки работы.',
    },
    {
        number: '03',
        title: 'Обработка и сборка тура',
        text: 'Собираем интерактивный маршрут и готовим финальный формат за 3-5 рабочих дней.',
    },
    {
        number: '04',
        title: 'Передача и запуск',
        text: 'Передаём ссылку, iframe-код и инструкцию по размещению.',
    },
];
