            ...
            <div className="container mx-auto px-6">
                <div className="max-w-3xl mb-10">
                    ...
                    <p className="text-white/70 leading-relaxed">
                        Здесь подготовлены места под реальные метрики и источники. Данные и ссылки добавляются на следующем этапе.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-5">
                    <article className="rounded-[12px] border border-[#2a2a2a] bg-[#141414] p-6">
                        ...
                        <div className="h-48 rounded-[10px] border border-dashed border-white/25 bg-[#101010] flex items-center justify-center">
                            <p className="text-xs uppercase tracking-wider text-white/45">динамика конверсии / вовлечённости</p>
                        </div>
                        <p className="text-xs text-white/50 mt-3">Место для графика с подписью метрики и периода сравнения.</p>
                    </article>
                    ...
                    <article className="rounded-[12px] border border-[#2a2a2a] bg-[#141414] p-6">
                        ...
                        <ul className="space-y-2 text-sm text-white/65 leading-relaxed">
                            <li>• Источник 1 (отчёт по hospitality)</li>
                            <li>• Источник 2 (исследование booking-платформы)</li>
                            <li>• Источник 3 (рыночная аналитика)</li>
                            <li>• Источник 4 (внутренние кейс-данные)</li>
                        </ul>
