...
export function TourContact() {
    ...
    const serviceOptions = ['360° тур для отеля', 'Встраивание на сайт', 'Booking-платформы', 'Маркетинговые кампании', 'Курорт / мультизоны'];
        ...
        <section className="py-20 bg-[#080808]" id="contact">
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto rounded-2xl border border-[#D4A017]/35 bg-gradient-to-br from-[#141414] via-[#111111] to-[#0d0d0d] p-6 md:p-8">
                    <h2 className="text-3xl font-bold mb-3 text-white">Обсудим ваш проект для отеля</h2>
                    <p className="text-white/70 mb-8 max-w-2xl leading-relaxed">
                        Оставьте задачу и контакты — предложим оптимальный пакет для сайта, booking-каналов и продаж.
                    </p>
                    ...
                    <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div>
                            ...
                            <textarea
                                rows={3}
                                placeholder="Тип отеля, количество зон, сроки, где планируете размещать тур"
