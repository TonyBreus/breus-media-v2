    ...
    const plans = [
        {
            ...
            price: 'от 650 ₾',
            features: [
                'Съёмка ключевых категорий номеров',
                'Базовая сборка 360° тура',
                'Прямая ссылка для отдела продаж',
            ],
            featured: false,
        },
        {
            ...
            price: 'от 1 100 ₾',
            features: [
                'Номера + лобби + ключевые общие зоны',
                'Embed-код + брендированное превью + QR',
                'Материалы для сайта и booking-страниц',
            ],
            featured: true,
            tag: 'Популярно',
        },
        {
            ...
            price: 'от 1 700 ₾',
            features: [
                'Съёмка многозонального объекта',
                'Teaser-клип для маркетинговых кампаний',
                'Полный placement-ready пакет для hospitality',
            ],
            featured: false,
        },
    ];
