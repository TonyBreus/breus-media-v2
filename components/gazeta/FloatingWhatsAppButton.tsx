...
export function FloatingWhatsAppButton({ lang, text, href }: FloatingWhatsAppButtonProps) {
    ...
    // Hide this global button on V3-V13 where we have the specific A/B widget
    if (pathname?.includes('/drone-service-v3') || pathname?.includes('/drone-service-v4') || pathname?.includes('/drone-service-v5') || pathname?.includes('/drone-service-v6') || pathname?.includes('/drone-service-v7') || pathname?.includes('/drone-service-v8') || pathname?.includes('/drone-service-v9') || pathname?.includes('/drone-service-v10') || pathname?.includes('/drone-service-v11') || pathname?.includes('/drone-service-v12') || pathname?.includes('/drone-service-v13')) return null;
