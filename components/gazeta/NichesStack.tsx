...
const niches = [
    ...
    },
    {
        ...
        detailedContent: {
            ...
            services: [
                { title: "Видео для риелторов", desc: "Съёмка квартиры или дома: интерьер, экстерьер, район. Монтаж за 3–5 дней. От 400 GEL", link: realEstate },
                { title: "Видео для застройщиков", desc: "Презентационные ролики ЖК, рендеры и реальная съёмка для продаж и инвесторов", link: realEstate },
                { title: "Аэросъёмка объектов", desc: "DJI Air 3S, 4K. Облёт фасада, территории и района. 94% больше просмотров объявления", link: droneService },
                { title: "360° виртуальные туры", desc: "Интерактивный тур по объекту. Загрузка на SS.ge, MyHome.ge и ваш сайт", link: tours360 },
                { title: "Мониторинг стройки", desc: "Ежемесячные дрон-облёты с GPS-привязкой и PDF-отчётом для банков и инвесторов", link: monitoringStroiki },
                { title: "AI-упаковка объявлений", desc: "Улучшение фото, описания для порталов, Reels для соцсетей агентства", link: aiContent }
            ]
        }
    },
    {
        ...
        detailedContent: {
            ...
            services: [
                { title: "Видеотур по отелю", desc: "Номера, ресторан, бассейн, вид — cinematic видео 2–4 мин для сайта и Booking", link: hotels },
                { title: "Аэросъёмка территории", desc: "Дрон над отелем, парком и побережьем. Показывает локацию лучше любых слов", link: droneService },
                { title: "360° тур по номерам", desc: "Виртуальный тур который можно встроить на сайт, Booking и Google Maps", link: tours360 },
                { title: "Reels и сезонный контент", desc: "Ежемесячный контент-пакет: 8–12 вертикальных видео под Instagram и TikTok", link: reels },
                { title: "SMM для отеля", desc: "Ведение Instagram и TikTok — контент-план, съёмка, монтаж, коммуникация", link: hotels },
                { title: "AI-перевод и локализация", desc: "Описания номеров и постов на 3–5 языках через AI — для иностранных гостей", link: aiContent }
            ]
        }
    },
    {
        ...
        detailedContent: {
            ...
            services: [
                { title: "Фуд-видео и фото", desc: "Съёмка блюд, подачи и процесса приготовления. Для меню, сайта и соцсетей", link: restaurants },
                { title: "Атмосферный ролик", desc: "Видео 60–90 сек: интерьер, команда, гости, кухня. Для Instagram и Google Maps", link: restaurants },
                { title: "Reels-пакет", desc: "5–10 вертикальных видео в месяц: блюда, акции, атмосфера, команда", link: reels },
                { title: "Дизайн меню", desc: "Обновление меню с фото и дизайном. Print-ready + цифровая версия. От 600 GEL", link: restaurants },
                { title: "Google Maps визуал", desc: "Фото и видео для Google Business — выше в поиске «рестораны рядом»", link: restaurants },
                { title: "SMM под ключ", desc: "Контент-план, съёмка, монтаж и ведение Instagram ресторана", link: restaurants }
            ]
        }
    },
    {
        ...
        detailedContent: {
            ...
            services: [
                { title: "Обзорное видео автомобиля", desc: "Внешний вид, интерьер, динамика — видео 60–90 сек для продаж и соцсетей", link: auto },
                { title: "Аэросъёмка дилерского центра", desc: "Дрон над салоном и стоянкой — масштаб и статус для рекламы и сайта", link: droneService },
                { title: "Reels и Shorts для автосалона", desc: "Короткие вирусные видео: новинки, тест-драйвы, спецпредложения", link: reels },
                { title: "Контент для автопроката", desc: "Съёмка парка автомобилей, условий аренды и локаций для туристов", link: auto },
                { title: "AI-описания для объявлений", desc: "Продающие тексты на RU/EN/GE для auto.ge, myauto.ge и международных площадок", link: aiContent },
                { title: "Брендовое видео компании", desc: "Имиджевый ролик дилерского центра или сервиса для сайта и презентаций", link: promoVideo }
            ]
        }
    },
    {
        ...
        detailedContent: {
            ...
            services: [
                { title: "Аэросъёмка локаций", desc: "Горы, побережье, города — cinematic дрон-видео для туристических маршрутов", link: droneService },
                { title: "Видеогид по маршруту", desc: "Документальный ролик 3–7 мин о туре или направлении. Для YouTube и сайта", link: tourism },
                { title: "Reels для турагентства", desc: "Контент-пакет: топ-локации, отзывы туристов, моменты из туров", link: reels },
                { title: "360° тур по локации", desc: "Интерактивная панорама горы, пещеры, замка или курорта", link: tours360 },
                { title: "Контент для экотуризма", desc: "Видео и фото природных парков, треккинговых маршрутов и глэмпингов", link: tourism },
                { title: "Промо для иностранных туристов", desc: "Видео на EN/DE/FR с субтитрами — для Booking, TripAdvisor и YouTube", link: promoVideo }
            ]
        }
    },
    {
    ...
    },
    {
        ...
        detailedContent: {
            ...
            services: [
                { title: "Продуктовое видео", desc: "Демо-ролик продукта или приложения — для инвесторов, сайта и App Store", link: promoVideo },
                { title: "Кейс-стади в видео", desc: "История клиента до/после внедрения вашего продукта. Лучший B2B-контент", link: it },
                { title: "Видео для инвесторов", desc: "Pitch-видео стартапа: команда, продукт, рынок. 60–120 сек", link: promoVideo },
                { title: "AI-контент для LinkedIn и X", desc: "Регулярный контент: новости компании, мнения экспертов, продуктовые обновления", link: aiContent },
                { title: "Корпоративная съёмка", desc: "Команда, офис, культура компании — для найма, PR и партнёрств", link: it },
                { title: "Reels для IT-бренда", desc: "Короткие видео о продукте, команде и технологиях для Instagram и TikTok", link: reels }
            ]
        }
    },
    {
        ...
        detailedContent: {
            ...
            services: [
                { title: "Расскажите о вашем проекте", desc: "Опишите задачу — предложим формат, сроки и стоимость под ваш бюджет", link: customBusiness },
                { title: "Пакет «Старт»", desc: "Видео + фото + 5 Reels для нового бизнеса. Всё необходимое для запуска", link: customBusiness },
                { title: "Разовая съёмка", desc: "Один выезд — фото, видео, дрон. Всё в одном визите от 500 GEL", link: customBusiness },
                { title: "AI-упаковка с нуля", desc: "Контент без съёмки: AI-визуал, сценарии, тексты, дизайн для соцсетей", link: aiContent },
                { title: "Ежемесячный контент", desc: "Абонемент на регулярный контент — не думаете о соцсетях, мы делаем всё", link: customBusiness },
