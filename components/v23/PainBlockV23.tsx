...
export default function PainBlockV23() {
    return (
        <section className="py-24 bg-[#0F0F0F] text-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <strong className="text-white">Отсутствие визуала — это барьер неизвестности</strong>, который стоит <span className="text-red-500 font-bold">бизнесу клиентов.</span>
                </motion.p>
