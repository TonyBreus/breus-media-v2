...
export const DRONE_CATEGORIES_V15: DroneCategory[] = [
    {
        id: 'real-estate-land',
...
export const DRONE_SERVICES_ITEMS_V15: DroneServiceCard[] = [
    {
        slug: 'nedvizhimost',
...
export const DroneServicesCatalogV15 = () => {
    ...
    const filteredItems = useMemo(() => {
        let items = DRONE_SERVICES_ITEMS_V15.filter((item) => item.categoryIds.includes(activeTab));
    ...
    const activeCategoryData = DRONE_CATEGORIES_V15.find((c) => c.id === activeTab);
