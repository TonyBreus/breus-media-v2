...
export const DroneServicesHorizontalClustersV8 = () => {
    ...
    const scrollToCluster = (clusterId: string) => {
        ...
        const container = carouselRef.current;
        // Approximation of card width + gap. 
        // 85vw max 340px + gap-3 (12px)
        // A more reliable way is to query the DOM node of the card
    ...
    return (
        <DebugWrapper id={11008} label="Drone Services Horizontal Clusters V8">
            <section className="py-12 md:py-20 bg-[#080808]">
                ...
                {/* Horizontal Chips */}
                <div className="flex overflow-x-auto no-scrollbar space-x-2 px-6 mb-6">
                    {CLUSTERS.map(cluster => {
                        ...
                        return (
                            <button
                                ...
                                className={`whitespace-nowrap px-4 py-2 rounded-full text-xs transition-colors shrink-0 ${
                                    isActive 
