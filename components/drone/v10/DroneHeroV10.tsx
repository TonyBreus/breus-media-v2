...
export const DroneHeroV10 = () => {
    ...
    return (
        <DebugWrapper id={14002} label="Drone Hero V10">
            <section className="relative isolate min-h-[100vh] min-h-[100dvh] overflow-hidden bg-[#080808] border-b border-[#2a2a2a] pt-16 md:pt-24 pb-12 flex flex-col justify-center">
                ...
                <div className="container relative z-10 mx-auto px-6 h-full flex items-center justify-center">
                    {/* Контейнер смещен вверх на 10-15% (-translate-y-8 sm:-translate-y-12) для идеального оптического центра над нижней границей */}
                    <div className="w-full max-w-4xl text-center -translate-y-8 sm:-translate-y-12 transition-transform duration-300">
