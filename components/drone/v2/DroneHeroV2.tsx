...
type DroneHeroV2Props = {
    hero: DroneDirectionHeroConfig;
};

export const DroneHeroV2 = ({ hero }: DroneHeroV2Props) => {
    return (
        <DebugWrapper id={11000} label="Drone Hero V2">
                ...
                <div className="relative z-10 w-full max-w-[1400px] px-6 flex flex-col items-center text-center mt-12 md:mt-0">
                    ...
                    <div className="flex flex-wrap justify-center gap-2 mb-6 md:mb-8">
                        <span className="flex items-center gap-1.5 px-3 md:px-4 py-1.5 md:py-2 bg-white/10 backdrop-blur-md rounded-full text-[10px] md:text-xs font-bold uppercase tracking-wider text-white border border-white/20">
                            <MapPin className="w-3.5 h-3.5 text-[#D4A017]" /> Тбилиси и регионы
                        </span>
                        <span className="flex items-center gap-1.5 px-3 md:px-4 py-1.5 md:py-2 bg-white/10 backdrop-blur-md rounded-full text-[10px] md:text-xs font-bold uppercase tracking-wider text-white border border-white/20">
                            <Clock className="w-3.5 h-3.5 text-[#D4A017]" /> Сдача от 24ч
                        </span>
                        <span className="flex items-center gap-1.5 px-3 md:px-4 py-1.5 md:py-2 bg-white/10 backdrop-blur-md rounded-full text-[10px] md:text-xs font-bold uppercase tracking-wider text-white border border-white/20">
                    ...
                    >
                        Аэросъёмка дроном <br className="hidden sm:block"/>
                    ...
                    >
                        Съемка на флагманские дроны DJI (4K/60fps HDR) и кинематографичный FPV внутри помещений. Для девелоперов, отельеров, B2B-инспекций и брендов.
                    </motion.p>
