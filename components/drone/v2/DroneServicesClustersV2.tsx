...
export const DroneServicesClustersV2 = () => {
    ...
    return (
        <DebugWrapper id={11001} label="Drone Services Clusters V2">
                ...
                <div className="mx-auto w-full max-w-[1400px] px-6">
                    <div className="mb-10 md:mb-16 text-center md:text-left">
                        <p className="text-[10px] md:text-xs uppercase tracking-[0.2em] text-[#D4A017] font-semibold mb-2">
                            Все {droneServiceItems.length} услуг в 4 кластерах
                        </p>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
                            Ключевые направления
                        </h2>
                        <p className="max-w-2xl text-sm md:text-base text-white/60 leading-relaxed">
                            Мы систематизировали наши услуги по отраслям. Выберите ваш профиль, чтобы посмотреть доступные решения.
                        </p>
                    </div>
