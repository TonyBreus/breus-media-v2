...
export const DRONE_CATEGORIES_V16: DroneCategory[] = [
    {
        id: 'real-estate-land',
        label: 'Недвижимость и участки',
        description: 'Застройщикам и риелторам: высотные 4K-облёты ЖК, видовых этажей и границ участков с акцентом на инфраструктуру. Готовые материалы для публикации на MyHome.ge и SS.ge от 24 часов.',
    },
    {
        id: 'horeca',
        label: 'Отели и рестораны',
        description: 'Единый 4K-пролёт на FPV-дроне сквозь залы, веранды и террасы. Показываем реальную атмосферу для роста бронирований в Google Maps, Instagram и Booking.',
    },
    {
        id: 'construction-inspection',
        label: 'Стройка и инспекции',
        description: 'Регулярный аэромониторинг стройплощадок, фотофиксация фасадов и кровли без дорогой аренды автовышек. Точный контроль подрядчиков и отчёты инвесторам за 24–48 часов.',
    },
    {
        id: 'brands-fpv',
        label: 'Бренды и FPV',
        description: 'Скоростная FPV-съёмка динамичных сцен, автомобилей и интерьеров. Захватывающие 4K-видео под алгоритмы Instagram Reels и TikTok.',
    },
    {
        id: 'events-tourism',
        label: 'События и туризм',
        description: 'Масштабная аэросъёмка природных локаций, свадеб и спортивных выездов по всей Грузии. Чистый 4K-материал и монтаж со сдачей от 48 часов.',
    },
    {
        id: 'pilot-rental',
...
export const DRONE_SERVICES_ITEMS_V16: DroneServiceCard[] = [
    {
        slug: 'nedvizhimost',
        title: 'Аэросъёмка недвижимости и ЖК',
        lsiSubtitle: 'MYHOME.GE · SS.GE · ВИДОВЫЕ ЭТАЖИ',
    ...
    },
    {
        ...
        lsiSubtitle: 'ГРАНИЦЫ · РЕЛЬЕФ · КАДАСТР',
        categoryIds: ['real-estate-land'],
        status: 'soon',
        priceAnchor: 'от 200 ₾',
    ...
    },
    {
        ...
        lsiSubtitle: 'BOOKING · AIRBNB · GOOGLE MAPS',
        categoryIds: ['horeca'],
        status: 'ready',
    ...
    },
    {
        ...
        lsiSubtitle: 'ТЕРРАСЫ · ROOFTOP · REELS',
        categoryIds: ['horeca'],
        status: 'ready',
    ...
    },
    {
        ...
        lsiSubtitle: 'ПРИРОДА · МАРШРУТЫ · ШАТО',
    ...
    },
    {
        ...
        lsiSubtitle: 'ТЕХНАДЗОР · БАНКИ · ИНВЕСТОРЫ',
    ...
    },
    {
        ...
        lsiSubtitle: 'ФИКСАЦИЯ ЭТАПОВ · GPS-ОТЧЁТЫ',
        categoryIds: ['construction-inspection', 'real-estate-land'],
        status: 'soon',
        priceAnchor: 'от 200 ₾',
    ...
    },
    {
        ...
        lsiSubtitle: 'ВЫСОТА · БЕЗ ЛЕСОВ · БЕЗОПАСНО',
    ...
    },
    {
        ...
        lsiSubtitle: 'ДЕФЕКТОВКА ШВОВ · БЕЗ ВЫШЕК',
        categoryIds: ['construction-inspection'],
        status: 'soon',
        priceAnchor: 'от 200 ₾',
    ...
    },
    {
        ...
        lsiSubtitle: 'ПРИМЫКАНИЯ · ВОДОСТОКИ · КРОВЛЯ',
        categoryIds: ['construction-inspection'],
        status: 'soon',
        priceAnchor: 'от 200 ₾',
    ...
    },
    {
        ...
        lsiSubtitle: 'ДЕФЕКТЫ · ЗАГРЯЗНЕНИЯ · КПД',
        categoryIds: ['construction-inspection'],
        status: 'soon',
        priceAnchor: 'от 200 ₾',
    ...
    },
    {
        ...
        lsiSubtitle: 'ПРОЛЁТ ВНУТРИ · 1 ДУБЛЬ · 100 КМ/Ч',
    ...
    },
    {
        ...
        lsiSubtitle: 'АВТОДИЛЕРЫ · ШОУРУМЫ · ДИНАМИКА',
    ...
    },
    {
        ...
        lsiSubtitle: 'ЛОГИСТИКА · СТЕЛЛАЖИ · ЦЕХА',
        categoryIds: ['brands-fpv'],
        status: 'soon',
        priceAnchor: 'от 300 ₾',
        tags: ['FPV', 'ПЛАНИРОВКА'],
    ...
    },
    {
        ...
        lsiSubtitle: 'СТАДИОНЫ · АРЕНЫ · МАСШТАБ',
        categoryIds: ['brands-fpv'],
        status: 'soon',
        priceAnchor: 'от 450 ₾',
        tags: ['4K', '60FPS', 'ОБЛЁТ'],
    ...
    },
    {
        ...
        lsiSubtitle: 'ФЕСТИВАЛИ · ОПЕН-ЭЙР · ИВЕНТЫ',
        categoryIds: ['events-tourism'],
        status: 'soon',
        priceAnchor: 'от 450 ₾',
    ...
    },
    {
        ...
        lsiSubtitle: 'РЕКЛАМА · ПРОМО · D-LOG ЦВЕТ',
        categoryIds: ['events-tourism'],
        status: 'soon',
        priceAnchor: 'от 700 ₾',
    ...
    },
    {
        ...
        lsiSubtitle: 'ВИНОГРАДНИКИ · ШАТО · УРОЖАЙ',
        categoryIds: ['events-tourism'],
        status: 'soon',
        priceAnchor: 'от 200 ₾',
    ...
    },
    {
        ...
        lsiSubtitle: 'DJI AIR 3S / AVATA 2 · ИСХОДНИКИ',
...
export const DroneServicesCatalogV16 = () => {
    ...
    const filteredItems = useMemo(() => {
        let items = DRONE_SERVICES_ITEMS_V16.filter((item) => item.categoryIds.includes(activeTab));
    ...
    const activeCategoryData = DRONE_CATEGORIES_V16.find((c) => c.id === activeTab);
        
    const hasReadyItems = filteredItems.some(i => i.status === 'ready');

    return (
        <DebugWrapper id="drone-services-catalog-v16" className="w-full bg-black py-10 md:py-20 border-t border-white/10">
                                    ...
                                    <div className="flex items-center gap-2 mt-auto">
                                        {isReady ? (
                                            ...
                                            <a 
                                                ...
                                                target="_blank" 
                                                rel="noopener noreferrer" 
                                                className="w-full py-2.5 px-4 bg-white/10 hover:bg-white/15 border border-white/10 hover:border-white/25 rounded-xl text-[11px] sm:text-xs font-bold text-white text-center flex items-center justify-center gap-1.5 transition-all uppercase tracking-wider"
                                            >
