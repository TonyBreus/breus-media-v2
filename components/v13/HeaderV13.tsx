...
export default function HeaderV13() {
        ...
        >
            <div className={`container mx-auto px-6 flex justify-between items-center transition-all duration-300 ${isScrolled ? 'h-[80px]' : 'h-[100px]'} relative z-[60]`}>
                ...
                <div className="flex items-center">
                    ...
                    {/* Contact Stack (UPDATED TO MATCH SCREENSHOT) */}
                        ...
                        <AnimatePresence>
                            {isContactOpen && (
                                <motion.div
                                    ...
                                    style={{ originY: 0 }}
                                    className="absolute top-0 right-0 pt-16" // Spacer to not overlap trigger
                                >
                                    <div className="bg-black border border-white/20 rounded-2xl p-6 w-80 shadow-2xl flex flex-col gap-6 relative z-[70]">
                                        ...
                                        {/* Quick Action Button (Floating) - Visual Match for Screenshot Top Right */}
