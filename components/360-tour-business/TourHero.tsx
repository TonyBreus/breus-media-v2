    ...
    return (
        <section id="tour-hero" className="relative pt-40 md:pt-44 pb-28 min-h-[calc(100vh-80px)] bg-[#080808] border-b border-[#2a2a2a]">
            <div className="container mx-auto px-6">
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[0.95] mb-6">360° тур для офисов и коворкингов</h1>
                <p className="text-base md:text-xl text-white/75 max-w-3xl leading-relaxed">
                    Арендатор или будущий сотрудник осматривает ваше пространство дистанционно — оценивает планировку,
                    инфраструктуру и атмосферу до физического визита. Особенно востребовано в Тбилиси для иностранных
                    компаний которые ищут офис удалённо.
                </p>
                <p className="text-sm text-white/65 max-w-3xl leading-relaxed mt-4">
                    Тур работает для аренды, HR-брендинга и корпоративных презентаций — один формат закрывает несколько
                    задач.
                </p>
                <p className="text-xs text-white/50 max-w-3xl leading-relaxed mt-3">
                    Работаем с офисами и коворкингами в Тбилиси. Другие города Грузии — по договорённости.
                </p>
