const reasons = [
    {
        ...
        text: 'Знаем рынок офисной недвижимости и коворкингов Грузии.',
    },
    {
        title: 'Съёмка без остановки работы',
        text: 'Приезжаем до начала рабочего дня или в выходные. 1–3 часа на объекте.',
    },
    {
        title: 'Тур работает в любом канале',
        text: 'Сайт, вакансии, мессенджеры, презентации — один тур везде.',
    },
    {
        title: 'Работаем с несколькими форматами',
        text: '360° тур, промо-видео, Reels — можем собрать полный визуальный пакет для вашего пространства.',
    },
];
