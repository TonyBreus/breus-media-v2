                ...
                <div className="grid lg:grid-cols-3 gap-5">
                    <article className="rounded-[12px] border border-[#2a2a2a] bg-[#141414] p-6">
                        ...
                        <ul className="space-y-3 text-sm text-white/75 leading-relaxed">
                            <li>
                                Компании активнее используют визуальный контент об офисе в найме — это влияет на
                                качество откликов на вакансии
                                <span className="block text-xs text-white/50 mt-1">LinkedIn Talent Trends, 2024</span>
                            </li>
                            <li>
                                Иностранные компании и релоканты выбирают офис в Тбилиси дистанционно — визуальное
                                присутствие онлайн становится решающим фактором
                            </li>
                        </ul>
                    </article>
                        ...
                        <table className="w-full min-w-[320px] text-sm text-white/80">
                            ...
                            <tbody>
                                <tr className="border-b border-white/10">
                                    <td className="py-2 pr-2">Иностранный арендатор</td>
                                    <td className="py-2 pr-2 text-white/60">Нужен визит</td>
                                    <td className="py-2">Выбирает онлайн</td>
                                </tr>
                                <tr className="border-b border-white/10">
                                    <td className="py-2 pr-2">Кандидат на работу</td>
                                    <td className="py-2 pr-2 text-white/60">Не видит офис</td>
                                    <td className="py-2">Видит в вакансии</td>
                                </tr>
                                <tr className="border-b border-white/10">
                                    <td className="py-2 pr-2">Пустые показы</td>
                                    <td className="py-2 pr-2 text-white/60">Случаются</td>
                                    <td className="py-2">Меньше</td>
                                </tr>
                                <tr>
                                    <td className="py-2 pr-2">Конкуренция онлайн</td>
                                    <td className="py-2 pr-2 text-white/60">Слабое присутствие</td>
                                    <td className="py-2">Сильная позиция</td>
                                </tr>
                            </tbody>
                        </table>
                    </article>
                    ...
                    <article className="rounded-[12px] border border-[#2a2a2a] bg-[#141414] p-6">
                        ...
                        <ul className="space-y-2 text-sm text-white/70 leading-relaxed">
                            <li>• LinkedIn Talent Trends, 2024</li>
                            <li>• Практика дистанционного выбора офисов иностранными компаниями</li>
                            <li>• Данные коворкингов Тбилиси о поведении арендаторов онлайн</li>
                        </ul>
                    </article>
                </div>
            </div>
