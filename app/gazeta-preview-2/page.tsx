...
import { ChooserLayoutBento } from "@/components/gazeta/layouts/ChooserLayoutBento";
...
export const metadata = {
    title: "Gazeta Preview 2 — Bento Terminal | Breus Media",
    description: "Preview 2: Bento Terminal layout for services and industries selector",
};

export default function GazetaPreview2Page() {
    return (
        <main className="min-h-screen bg-black text-white">
            ...
            <div className="sticky top-0 z-[100] flex items-center justify-between border-b border-white/10 bg-black/90 px-4 py-2 text-xs backdrop-blur-md">
                <div className="flex items-center gap-2">
                    ...
                    <span className="font-mono font-bold text-[#FFD23F] uppercase">Preview 2: Bento Terminal</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <SmartHeader
                ...
                ctaHref="#contact"
                initialLang="RU"
                languageLinks={{ RU: "/gazeta-preview-2", EN: "/gazeta-preview-2" }}
            />

            <HeroSection lang="ru" />

            <div id="niches">
                <ChooserLayoutBento lang="ru" />
            </div>
