...
const commercialFaqItems: FaqItem[] = [
    ...
    {
        question: 'Есть ли app-кабинет и полностью автоматическое сравнение выездов?',
        answer:
            'Сейчас базовая работа идёт в структурированном ручном/полуавтоматическом формате: повторяемые точки, визуальная сводка и архив. App-based отчётность и продвинутые автоматические сравнения доступны как future capability по индивидуальному roadmap.',
    },
];
...
const benefitCards: ListCard[] = [
    {
        ...
        text: 'Каждая съёмка датирована и передаётся по единой логике, чтобы прогресс читался без хаоса.',
    },
    {
    ...
    {
        title: 'Визуальная база для коммуникации по milestone',
        text: 'Отчёт с фото и датами помогает обсуждать этапы с партнёрами и финансирующей стороной.',
    },
    {
    ...
    },
    {
        ...
        text: 'Расширенную investor-ready упаковку подключаем отдельно, когда она реально нужна проекту.',
    },
    {
...
const deliverablePackages: PackageCard[] = [
    ...
    {
        title: 'CORE: Регулярный мониторинг',
        subtitle: 'База для операционного контроля',
        items: [
...
export default function DroneConstructionMonitoringPage() {
    return (
        <main className="bg-[#080808] text-white min-h-screen clean-debug-overlays">
                        ...
                        <div className="grid items-end gap-12 lg:grid-cols-[minmax(0,1.1fr)_360px]">
                            <div>
                                ...
                                <p className="mt-6 max-w-3xl text-base leading-relaxed text-white/78 md:text-xl">
                                    ...
                                    часа. Investor/bank-ready формат подключается как расширенный premium слой.
                                </p>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="max-w-3xl">
                            <h2 className="text-3xl font-bold md:text-4xl">Что вы получаете после съёмки</h2>
                                <p className="mt-4 leading-relaxed text-white/70">
                                База остаётся простой и понятной: выезд, фиксация прогресса, передача материалов.
            ...
            <DebugWrapper id={382602} label="Future Capability Note">
                <ProcessNote text="App-based отчётность, полуавтоматические сравнения и продвинутая продуктовая логика доступны как future capability и подключаются по индивидуальному roadmap, а не как базовое обещание по умолчанию." />
            </DebugWrapper>
