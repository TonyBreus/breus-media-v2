...
import { DroneServicesHorizontalClustersV8 } from '@/components/drone/v8/DroneServicesHorizontalClustersV8';
...
export const metadata: Metadata = {
    title: 'Аэросъёмка для бизнеса в Грузии | V8',
...
export default function DroneServiceV8Page() {
    return (
        <main className="relative min-h-screen bg-[#080808] text-white selection:bg-[#D4A017] selection:text-black">
            ...
            <div id="catalog">
                <DroneServicesHorizontalClustersV8 />
            </div>
