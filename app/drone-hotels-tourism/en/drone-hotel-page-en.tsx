...
const relatedServices: RelatedService[] = [
    {
        ...
        text: 'Interactive tours for the website and booking platforms (Booking, Airbnb) so guests can explore the space in detail before booking.',
    },
    {
        title: 'Drone filming for restaurants',
        href: '/drone-services/drone-restaurants/en',
        text: 'If your hotel features a restaurant, rooftop bar or terrace, we capture both hospitality and dining spaces in a single shoot.',
    },
    {
        title: '360° tours for real estate',
        href: '/360-tour-real-estate/en',
        text: 'Interactive virtual walkthroughs for apartments, villas and investment properties.',
    },
];
...
export default function DroneHotelsTourismEnPage() {
    return (
        <main className="min-h-screen bg-[#080808] pb-20 text-white lg:pb-0">
                ...
                <section id="pricing" className="border-b border-[#2a2a2a] bg-[#080808] py-24">
                    <div className="container mx-auto px-6">
                        <div className="max-w-3xl">
                            ...
                            <p className="mt-4 leading-relaxed text-white/70">Fixed prices in Georgian lari (₾). No hidden fees. Pick the package that matches the brief — from a basic shoot to the full cycle.</p>
                            <p className="mt-2 text-sm leading-relaxed text-white/55">
                                Every photo and video is delivered in 4K — ready to use. Any package can be extended with social / website / Google Maps edits, music, subtitles in the languages you need and 360° panoramas.
                            </p>
                        </div>
                        ...
                        <div className="mt-8 rounded-[16px] border border-[#FFD23F]/30 bg-[#121212] p-6">
                            ...
                            <p className="mt-2 text-sm leading-relaxed text-white/55">From a single shoot you can pull more than the main asset — extra cuts for the website, social, the Google Maps listing and sales.</p>
            ...
            <DroneStickyCta heroId="drone-hotels-tourism-hero" label="Discuss the brief" />
            <MobileBottomBar
                primaryLabel="Discuss the brief"
