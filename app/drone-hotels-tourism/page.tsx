...
const problemCards: CardItem[] = [
    {
        ...
        text: 'Аэросъёмка показывает территорию, расположение и атмосферу — то, что стандартным фото объяснить сложнее.',
    },
    {
        title: '«Главная ценность отеля — природа вокруг, но с земли это не передать»',
        text: 'Дрон даёт вид сверху: горы, море, виноградники — контекст локации, который продаёт направление.',
    },
    {
        title: '«Нужен контент для сайта, Booking и Reels — одна съёмка не закрывает всё»',
        text: 'Один выезд — hero video, вертикальные clips и обработанные аэрофото под каждую платформу.',
    },
    {
        title: '«Хочу показать бассейн, террасу, вид — но с земли угол неправильный»',
        text: 'Дрон снимает сверху и в движении: зоны отдыха, ландшафт, окружение — то, что гость хочет увидеть до бронирования.',
    },
    {
        title: '«Ищем локального оператора с предсказуемой сметой и коммуникацией на EN»',
        text: 'Фиксированная структура пакетов, line-item смета, работа по GCAA, коммуникация на RU/EN.',
    },
    {
        title: '«Не понимаю, что заказать и сколько стоит»',
        text: 'На странице — пакеты с ценами в ₾, составом и сроками. Расчёт под ваш объект — бесплатно.',
    },
];

const shootingZones: string[] = [
    'Фасад и вход в отель',
    'Территория: бассейн, сад, двор, набережная',
    'Rooftop-терраса или смотровая зона',
    'Вид из номеров (exterior reveal)',
    'Окружение: город, горы, море, виноградники',
    'FPV-пролёт по лобби или ключевым зонам — по согласованию',
];
...
const deliverablesDefault: string[] = [
    ...
    'Набор обработанных аэрофото / stills',
    'Организованная выдача файлов по назначению (сайт, OTA, соцсети)',
    'Формат под задачу: горизонталь, вертикаль или оба',
];

const pricingCards: DeliverablePackage[] = [
    {
        title: 'STARTER HOTEL SHOOT',
        price: '450–680 ₾',
        audience: 'Городской отель, апарт-отель, Airbnb, сезонное обновление контента',
        items: [
            '1 съёмочный визит до 2 часов',
            'Exterior aerial shots: фасад, вход, территория, ближайший контекст',
            '1 highlight video 20–35 сек (горизонтальный)',
            '1 вертикальный cut для Reels / Stories',
            '15–20 обработанных аэрофото для OTA и сайта',
            'Выдача файлов по папкам (сайт, соцсети, OTA)',
        ],
        timeline: '48–72 часа',
        exclusions: 'FPV-пролёт внутри, вечерняя/ночная съёмка, продакшн с моделью / стайлинг',
    },
    {
        title: 'SIGNATURE HOTEL STORY',
        price: '880–1 350 ₾',
        audience: 'Курортный, SPA или бутик-отель, горный или эко-отель, объект с атмосферной территорией',
        items: [
            '1 съёмочный визит до 3–4 часов',
            'Exterior + ключевые зоны: бассейн, терраса, вид, ландшафт',
            'Спланированный маршрут полёта (drone route)',
            'FPV-пролёт по лобби или ключевым зонам — если пространство позволяет (обсуждается на брифе)',
            '1 hero video 45–75 сек',
            '3–4 вертикальных social cut',
            '25–35 обработанных аэрофото',
            'Cover / thumbnail + версия для Google Business Profile',
        ],
        timeline: '4–6 рабочих дней',
        exclusions: 'Full-day продакшн, кастинг, сложная аудиопродукция, несколько съёмочных дней',
        popular: true,
    },
    {
        title: 'PREMIUM HOSPITALITY CONTENT PACK',
        price: '1 800–2 600 ₾',
        audience: 'Международные отельные сети, resort-комплексы, флагманские объекты, рекламные кампании',
        items: [
            'Расширенный бриф: созвон + согласование маршрута до съёмки',
            'Full-day съёмка по шот-листу',
            'Exterior + interior + advanced route planning',
            'FPV walkthrough по ключевым зонам (где уместно)',
            '1 hero film 60–120 сек',
            '5–7 вертикальных cuts',
            '30–45 обработанных stills + hero-friendly assets для сайта',
            'Google Business Profile clip + акцент на key amenities',
            'Исходники (RAW) по запросу',
            'Line-item смета + коммуникация RU/EN',
        ],
        timeline: '5–8 рабочих дней',
        exclusions: 'Актёры/модели/стайлинг, тяжёлые VFX, мультидневный продакшн без согласования',
    },
];

const addonItems: AddonItem[] = [
    {
        title: 'FPV-пролёт по ключевым зонам отеля',
        text: 'FPV («от первого лица») — плавное движение камеры через лобби, коридор, pool area или rooftop. Гость видит маршрут и атмосферу ещё до заезда. Подходит не для каждого пространства — обсуждаем на брифе.',
    },
    {
        title: 'Дополнительный ролик / extra cut',
        text: 'Отдельная короткая версия, второй монтажный вариант или дополнительный формат под конкретную задачу (например, презентация для турагентства или event-менеджера).',
    },
    {
        title: 'Google Business Profile версия',
        text: 'Короткий ролик или набор аэрофото специально для карточки объекта в Google Business Profile и Google Maps.',
    },
    {
        title: '360° aerial panorama',
        text: 'Панорамный аэрокадр для сайта, OTA-профиля, презентации объекта или sales-материалов.',
    },
    {
        title: 'Исходники (RAW footage)',
        text: 'Если вашей команде нужен исходный материал для собственного монтажа, рекламной кампании или внутренней работы.',
    },
    {
        title: 'Дополнительные аэрофото / still pack',
        text: 'Обработанные кадры для OTA-карточек, сайта, email-рассылки, презентаций и маркетинговых материалов.',
    },
    {
        title: 'Ранний выезд (golden hour / sunrise)',
        text: 'По согласованию, если важно снять объект в мягком утреннем свете — особенно актуально для горных и курортных отелей.',
    },
    {
        title: 'Вечерний слот',
        text: 'По согласованию, если нужно показать вечернее освещение, пул-бар в сумерках, city lights или атмосферу terrace вечером.',
    },
];
...
const processSteps: ProcessStep[] = [
    {
        step: 'Шаг 1',
        title: 'Бриф',
        text: 'Рассказываете о типе объекта, целях и зонах съёмки. Предлагаем формат и пакет под задачу. Расчёт — в течение 2 часов.',
    },
    {
        step: 'Шаг 2',
        title: 'Подготовка',
        text: 'Согласовываем маршрут полётов, тайминг и ограничения локации. Для горных или специфических зон — проверяем GCAA заранее.',
    },
    {
        step: 'Шаг 3',
        title: 'Съёмка',
        text: 'Аэрокадры снаружи + FPV внутри по согласованному сценарию, если уместно. 2–4 часа на объекте. Работы в отеле не останавливаются.',
    },
    {
        step: 'Шаг 4',
        title: 'Монтаж и цвет',
        text: 'Собираем hero video, вертикальные cuts и обрабатываем кадры под целевые платформы.',
    },
    {
        step: 'Шаг 5',
        title: 'Выдача',
        text: 'Структурированная папка с готовыми файлами: сайт, OTA, Reels, Google. Один раунд правок при необходимости.',
    },
];
...
const nicheCards: NicheCard[] = [
    {
        ...
        deliverables: 'Hero + Reels + аэрофото для OTA.',
    },
    {
        ...
        deliverables: 'Cinematic hero + 3–5 Reels + 30+ аэрофото.',
    },
    {
    ...
    },
    {
        ...
        deliverables: 'Аэрофото + короткий highlight clip на каждый объект.',
    },
    {
        ...
        deliverables: 'Hero-ролик + серия clips под соцсети.',
    },
    {
        title: 'Международная отельная сеть',
        pain: 'Нужен локальный оператор с правильным workflow и коммуникацией на EN.',
        solution: 'Продакшн-пакет, line-item смета, исходники, работа в рамках GCAA.',
...
const whyUsCards: CardItem[] = [
    {
        ...
        text: 'Фокус не на полёте, а на том, чтобы гость понял расположение, атмосферу и ключевые преимущества объекта.',
    },
    {
        title: 'Два дрона под разные задачи',
        text: 'Air 3S — плавные стабильные аэрокадры снаружи. Avata 2 — FPV-пролёты внутри там, где это уместно. Не нужно выбирать между динамикой и стабильностью.',
    },
    {
        title: 'Контент сразу под все платформы',
        text: 'Hero-ролик, Reels, аэрофото для OTA — из одного выезда. Забираете готовый пакет без дополнительной адаптации.',
    },
    {
        title: 'Небольшая команда и быстрый контакт',
        text: 'Без лишних слоёв коммуникации: бриф, правки и вопросы решаются напрямую и быстро.',
    },
    {
        title: 'Работаем по правилам GCAA',
        text: 'Дрон зарегистрирован. Знаем ограничения по зонам. Для сложных локаций анализ воздушного пространства берём на себя.',
    },
    {
        title: 'Понятны для международных сетей',
        text: 'Коммуникация RU/EN, line-item смета, исходники по запросу, контекст Film in Georgia. Работаем как local drone unit с международным подходом.',
    },
];
...
const relatedServices: RelatedService[] = [
    ...
    },
    {
        ...
        text: 'Интерактивные туры для сайта и OTA, чтобы гость мог детально изучить пространство до бронирования.',
    },
    {
...
const faqItems: FaqItem[] = [
    ...
    },
    {
        ...
        answer:
            'Да. Отдаём в форматах, которые принимают основные платформы: JPG / WebP для фото, MP4 для видео. Горизонтальные версии для сайта и YouTube, вертикальные для Reels и мобильных OTA. Адаптируем под ваши требования.',
    },
    {
    ...
    },
    {
        ...
        answer:
            'Стартовый пакет — от 450 ₾ (до 2 часов, highlight clip и аэрофото). Signature-пакет с несколькими deliverables и опциональным FPV — от 880 ₾. Premium hospitality pack для международных сетей и resort-комплексов — от 1 800 до 2 600 ₾. Точный расчёт под ваш объект — бесплатно.',
    },
    {
        question: 'Сколько времени занимает съёмка?',
        answer:
            'Городской отель — 2–3 часа на объекте. Курортный отель с большой территорией — 3–4 часа. Full-day продакшн по шот-листу — по согласованию. Монтаж и доставка — 48–72 часа (starter) или 4–8 рабочих дней (signature и premium).',
    },
    {
    ...
    },
    {
        ...
        answer:
            'Да. Работаем в соответствии с правилами Georgian Civil Aviation Agency (GCAA). Анализ воздушного пространства и разрешительная подготовка — на нас.',
    },
    {
        question: 'Вы работаете с иностранными отельными сетями?',
        answer:
            'Да. Коммуникация на RU и EN, line-item смета, исходники по запросу. Понимаем требования к форматам и стандартам крупных международных сетей. Знаем контекст Film in Georgia (20–25% rebate на квалифицированные расходы).',
    },
    {
...
const serviceSchema = {
    ...
    description:
        'Аэросъёмка и FPV-видео для отелей, курортов и hospitality-объектов в Тбилиси и Грузии. Контент для сайта, Booking/OTA и соцсетей.',
    provider: {
        '@type': 'LocalBusiness',
        name: 'Breus Media',
        address: {
...
export const metadata: Metadata = {
    ...
    description:
        'Аэросъёмка и FPV-видео для отелей, курортов и hospitality-объектов в Тбилиси и Грузии. Контент для сайта, Booking и соцсетей. От 450 ₾.',
    alternates: {
    ...
    openGraph: {
        ...
        description:
            'Аэросъёмка и FPV-видео для отелей и курортов в Тбилиси от 450 ₾. Контент для Booking, сайта и Reels. Результат за 2–6 дней.',
        url: 'https://breus.media/drone-hotels-tourism',
                            ...
                            <aside className="rounded-[20px] border border-white/10 bg-[#101010]/90 p-6 shadow-[0_18px_60px_rgba(0,0,0,0.35)] backdrop-blur">
                                ...
                                <div className="mt-5 space-y-4">
                                    <div className="rounded-[14px] border border-white/10 bg-white/[0.03] p-4">
                                        ...
                                        <p className="mt-1 text-sm leading-relaxed text-white/65">Стартовый пакет для отелей и апарт-формата.</p>
                                    </div>
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <div className="rounded-[14px] border border-white/10 bg-white/[0.03] p-4">
                                            <p className="text-lg font-bold text-white">2–6 дней</p>
                                    ...
                                    <ul className="space-y-2 text-sm leading-relaxed text-white/72">
                                        ...
                                        <li>Горизонталь, вертикаль или оба — по задаче</li>
                                        <li>Тбилиси и другие регионы Грузии</li>
                                    </ul>
                                </div>
                            </aside>
                        </div>
                    ...
                    <div className="container mx-auto px-6">
                        ...
                        <div className="mt-10 grid gap-5 lg:grid-cols-3">
                            ...
                            <article className="rounded-[18px] border border-[#2a2a2a] bg-[#141414] p-6">
                                ...
                                <ul className="mt-5 space-y-3 text-sm leading-relaxed text-white/72">
                                    <li>+ FPV-пролёт по лобби / ключевым зонам</li>
                                    <li>+ Дополнительные вертикальные нарезки</li>
                                    <li>+ Версия для Google Business Profile</li>
                                    <li>+ Вечерний / golden hour слот</li>
                                    <li>+ 360° aerial panorama</li>
                                    <li>+ Двуязычные титры (RU + EN)</li>
                                    <li>+ Raw footage / исходники</li>
                                </ul>
                            </article>
                        </div>
                        ...
                        <div className="mt-5 grid gap-5 md:grid-cols-2">
                            <article className="rounded-[16px] border border-[#2a2a2a] bg-[#141414] p-6">
                                ...
                                <ul className="mt-4 space-y-2 text-sm leading-relaxed text-white/72">
                                    ...
                                    <li>`/ota-booking/` — горизонтальный clip и exterior stills для OTA</li>
                            ...
                            <article className="rounded-[16px] border border-[#2a2a2a] bg-[#141414] p-6">
                                ...
                                <p className="mt-4 rounded-[12px] border border-[#FFD23F]/25 bg-[#111111] px-4 py-3 text-sm text-white/80">
                                    Сроки: 48–72 часа (starter) или 4–8 рабочих дней (signature / premium).
                                </p>
                            </article>
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="max-w-3xl">
                            ...
                            <p className="mt-2 text-sm leading-relaxed text-white/55">
                                Диапазон итоговой цены зависит от трёх факторов: локация (Тбилиси или выезд), количество
                                зон съёмки и объём монтажа.
                            </p>
                        </div>
                        ...
                        <div className="mt-8 rounded-[16px] border border-[#FFD23F]/30 bg-[#121212] p-6">
                            ...
                            <p className="mt-3 leading-relaxed text-white/70">
                                Из одной съёмки можно собрать не только основной материал, но и дополнительные форматы под конкретные платформы или задачи.
                            </p>
