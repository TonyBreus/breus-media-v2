...
const pricingCards: PricingPackage[] = [
    {
        ...
        items: [
            'До 6 точек съёмки (лобби + номера + ванная)',
    ...
    {
        title: 'Отель Стандарт',
        price: '950 ₾',
        subtitle: 'Для бутик-отеля, городского отеля 3–4 звезды',
        items: [
            'До 15 точек съёмки (лобби, ресепшен, номера, ресторан)',
            'Ссылка + iframe-код',
    ...
    },
    {
        ...
        items: [
            'От 20 точек — все зоны объекта, включая СПА, фитнес',
            'Ссылка + iframe + несколько маршрутов',
            'Точки перехода с описаниями и ссылками',
            'Панорама для Google Maps',
...
const relatedServices: RelatedService[] = [
    {
        title: 'Аэросъёмка отеля и курорта',
    ...
    {
        title: 'Аэросъёмка ресторанов и террас',
        href: '/drone-services/drone-restaurants',
        text: 'Гость выбирает столик до визита. Аэросъёмка ресторана и террасы при отеле — инструмент привлечения гостей и туристов.',
    },
    {
        title: '360° виртуальные туры для недвижимости',
        href: '/360-tour-real-estate',
        text: 'Интерактивный тур для вилл, апарт-комплексов и инвестиционной недвижимости.',
    },
];
        ...
        <main className="min-h-screen bg-[#080808] pb-20 text-white lg:pb-0">
            ...
            <SmartHeader
                ...
                customTickerItems={[
                    ...
                    { text: 'АЭРОСЪЁМКА', link: '/drone-service' },
                    { text: '360° ТУРЫ', link: '/360-tour-hotels' },
                ]}
            ...
            <DebugWrapper id={386100} label="Hero Section">
                ...
                >
                    {/* Visual Anchor (4K Pan video background) */}
                    <div className="absolute inset-0 z-0">
                        <video
                            ...
                            src="/videos/360-hotel-tour-bg.mp4"
                        />
                    </div>
                    
                    <div
                        aria-hidden
                        className="absolute inset-0 z-0 bg-[linear-gradient(180deg,rgba(8,8,8,0.3),rgba(8,8,8,0.75)_75%,#080808)] backdrop-blur-[2px]"
                    />
                    <div
                        aria-hidden
            ...
            <DebugWrapper id={386180} label="Pricing Section">
                <section id="pricing" className="border-b border-[#2a2a2a] bg-[#0D0D0D] py-24">
                    <div className="container mx-auto px-6">
                        ...
                        <div className="mt-10 flex overflow-x-auto snap-x snap-mandatory gap-5 md:grid md:grid-cols-2 xl:grid-cols-3 pb-8 hide-scrollbar">
                            {pricingCards.map((card) => (
                                <article
                                    key={card.title}
                                    className={`snap-center shrink-0 w-[90vw] md:w-auto flex flex-col rounded-[20px] border p-6 ${
                                        card.popular
                        ...
                        {/* Mobile pagination hints (dots) */}
                        <div className="flex justify-center gap-2 md:hidden mb-8">
                            <div className="w-2 h-2 rounded-full bg-white/20"></div>
                            <div className="w-2 h-2 rounded-full bg-[#FFD23F]"></div>
                            <div className="w-2 h-2 rounded-full bg-white/20"></div>
                        </div>
