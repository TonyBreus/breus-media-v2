...
import { DroneHeaderV11 } from '@/components/drone/v11/DroneHeaderV11';
...
export const metadata: Metadata = {
    title: 'Аэросъёмка для бизнеса и частных объектов в Грузии | V11',
...
export default function DroneServiceV11Page() {
    return (
