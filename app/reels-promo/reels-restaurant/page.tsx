...
const beginnerFaqItems: FaqItem[] = [
    ...
    },
    {
        ...
        answer:
            'Лучше работает комбинация: трендовые звуки помогают охвату, а фирменный звук поддерживает имидж. Мы подбираем лицензионные треки, доступные в Instagram и TikTok, под атмосферу заведения.',
    },
    {
