...
export function SolarContactForm() {
    ...
    return (
        <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-5 md:grid-cols-2">
                <div>
                    <label className="mb-2 block text-[11px] font-bold uppercase tracking-[0.2em] text-white/50">Адрес объекта</label>
                    <input
                        type="text"
                        placeholder="Тбилиси, район..."
                        className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                    />
                </div>
                ...
                <div>
                    <label className="mb-2 block text-[11px] font-bold uppercase tracking-[0.2em] text-white/50">
                        Количество панелей / площадь
                    </label>
                    <input
                        type="text"
                        placeholder="Например: 48 панелей или 320 м²"
                        className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                    />
                </div>
            </div>
            ...
            <div>
                <label className="mb-2 block text-[11px] font-bold uppercase tracking-[0.2em] text-white/50">Что нужно проверить</label>
                <textarea
                    rows={4}
                    placeholder="Плановый осмотр / после шторма / приёмка после монтажа..."
                    className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                />
            </div>
            ...
            {submitted ? (
                <p className="rounded-[12px] border border-[#FFD23F]/30 bg-[#111111] px-4 py-3 text-sm leading-relaxed text-white/80">
                    Спасибо, запрос принят. Свяжемся с вами и уточним детали по объекту.
                </p>
            ) : null}
        </form>
    );
