...
const shootDayItems: string[] = [
    ...
    'Фотографии в высоком разрешении (DNG + JPEG экспорт) для передачи инженеру или в архив',
...
const commercialFaqItems: FaqItem[] = [
    ...
    },
    {
        ...
        answer:
            'Фото передаём в JPEG высокого разрешения с папочной структурой по фасадам и зонам. Видео — MP4 в 4K Ultra HD. Оригинальные DNG-исходники передаём по запросу.',
    },
    {
...
const pricingPackages: PricingPackage[] = [
    {
        ...
        addons: ['Оригинальные DNG-исходники +100 ₾', 'Детальные проходы по отдельным зонам +120 ₾', 'Срочная доставка (24 ч) +150 ₾'],
    },
    {
        ...
        items: [
            ...
            'Фотографии всех фасадов: 180–250 фото в JPEG + DNG',
    ...
    },
    {
        ...
        items: [
            ...
            'Полный фотопакет: 350+ фото, JPEG + DNG',
...
const mistakes: CardItem[] = [
    ...
    {
        title: 'Передавать материалы съёмки без структуры',
        text: 'Папка с сотнями файлов в случайном порядке тратит часы инженера и страховой. Чёткая структура выдачи по секторам — это стандарт.',
    },
];
