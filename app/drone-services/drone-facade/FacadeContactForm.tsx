...
export function FacadeContactForm() {
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input
                        type="text"
                        placeholder="Тбилиси, район, улица"
                        className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                    />
                </div>
                ...
                <div>
                    ...
                    <input
                        type="text"
                        placeholder="Например: 12 этажей, 2 корпуса"
                        className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <textarea
                    rows={4}
                    placeholder="Плановый осмотр / после ремонта / перед сделкой / страховая документация..."
                    className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                />
            </div>
