...
export function WineContactForm() {
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input
                        type="text"
                        placeholder="Тбилиси, Кахетия, Рача..."
                        className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                    />
                </div>
                <div>
                    ...
                    <input
                        type="text"
                        placeholder="Имидж / Reels / Ртвели / мониторинг"
                        className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                    />
                </div>
            </div>
            ...
            <div>
                ...
                <textarea
                    rows={4}
                    placeholder="Опишите объект, желаемые даты и что важно показать в кадре..."
                    className="w-full rounded-[14px] border border-white/12 bg-white/[0.03] px-4 py-3 text-white outline-none transition-colors placeholder:text-white/28 focus:border-[#FFD23F]/55"
                />
            </div>
