...
const painCards: CardItem[] = [
    ...
    {
        title: 'Нужен кастомный, а не стоковый визуал',
        text: 'Сток выглядит шаблонно. Кастомное AI-изображение создаётся точно под ваш бриф и айдентику.',
    },
];
...
const shortQaItems: FaqItem[] = [
    ...
    },
    {
        ...
        answer: 'AI генерирует кастомное изображение под ваш бриф, а не берёт готовое стоковое фото из общего каталога.',
    },
    {
...
const myths: CardItem[] = [
    ...
    {
        title: 'Миф: AI не может создать нестандартную сцену',
...
const longQaItems: { question: string; answers: string[] }[] = [
    ...
    },
    {
        ...
        answers: [
            ...
            'AI-визуал создаётся конкретно под ваш бриф и помогает выделиться выразительной визуальной подачей.',
        ],
    },
    {
