...
const deliverables: string[] = [
    ...
    'Описание каждого типа номеров — отдельный текст со специфическими характеристиками.',
...
const useCases: CardItem[] = [
    ...
    },
    {
        ...
        text: 'Пишем персонализированное описание для каждого типа с акцентом на отличия: вид, метраж, планировка, сценарий использования.',
    },
    {
...
const miniCases: CardItem[] = [
    ...
    },
    {
        ...
        text: 'Разделили 6 типов апартаментов на индивидуальные описания. Гости чаще выбирают более дорогие варианты, потому что видят разницу.',
    },
    {
...
const whyUsItems: string[] = [
    'AI + человек: не отдаём неотредактированный AI-текст, каждое описание проходит редактуру.',
