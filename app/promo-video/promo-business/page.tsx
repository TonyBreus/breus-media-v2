...
const painCards: Card[] = [
    ...
    },
    {
        ...
        text: 'Без флагманского ролика презентация выглядит незавершённой, даже если у вас сильный продукт, команда и клиентская база.',
    },
    {
...
const commercialFaqItems: FaqItem[] = [
    ...
    {
        question: 'Мы получаем исходные материалы?',
        answer:
            'В стандартный пакет оригинальный массив съёмки не входит. Передача оригинальных 4K видеоматериалов доступна как отдельная опция, если согласована до старта проекта.',
    },
    {
