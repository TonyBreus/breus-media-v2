        ...
        data: {
            ...
            services: [
                ...
                },
                {
                    ...
                    description: 'Гость выбирает стол ещё до визита. Детальный обзор зала и декора работает как круглосуточный менеджер по продажам.',
                    price: '360° · от 500 ₾',
                    image: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1200&q=80',
        ...
        data: {
            ...
            services: [
                ...
                },
                {
                    ...
                    order: 2,
                    slug: 'reels-shorts',
                    title: 'Reels и регулярный контент',
                    category: 'Social · Reach · Engagement',
                    description: 'Серии коротких роликов для регулярного присутствия в соцсетях.',
                    price: 'Short-form · от 450 ₾',
            ...
            services: [
                {
                    ...
                    category: 'Застройщик · Архитектор · Дизайнер',
                    description:
                ...
                },
                {
                    ...
                    title: 'AI staging и виртуальная меблировка',
                    category: 'Агентство · Собственник · Листинг.',
                    description:
                ...
                },
                {
                    ...
                    category: 'Отельер · Ресторатор · Инвестор',
                    description:
                ...
                },
                {
                    ...
                    category: 'Бренд · Маркетплейс · Ритейл',
                    description:
                ...
                },
                {
                    ...
                    category: 'Дилер · Автопарк · Детейлинг',
                    description:
                ...
                },
                {
                    ...
                    category: 'Кампании · Лендинги · Маркетинг',
                    description:
                ...
                },
                {
                    ...
                    title: 'AI-описания для отеля',
                    category: 'Гостиница · Airbnb · Номера',
                    description:
                ...
                },
                {
                    ...
                    category: 'Туроператор · Гид · Экскурсии',
                    description:
                        'Когда маршруты есть, но тексты собраны хаотично, туры продаются слабее. Мы упаковываем ваши предложения в структурированный каталог на русском и английском — с карточками, заголовками, FAQ и описаниями для размещения.',
                    price: 'Подача · Локализация · Сценарии',
                    image: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=1200&q=80',
                    primaryHref: '/ai-content/tourism-ai-packaging',
                },
            ],
            ...
            services: [
                {
                    ...
                    category: 'Риелтор · Застройщик · Девелопер',
                    description:
                ...
                },
                {
                    ...
                    category: 'Курорт · Резорт · Глэмпинг',
                    description:
                ...
                },
                {
                    ...
                    title: 'Reels для автобизнеса',
                    category: 'Автодилер · Площадка · Автобренд',
                    description:
                ...
                },
                {
                    ...
                    category: 'Туроператор · Трэвел-блогер',
                    description:
                ...
                },
                {
                    ...
                    category: 'Стоматология · Косметология · Врач',
                    description:
                ...
                },
                {
                    ...
                    category: 'Предприниматель · Стартап · Франшиза',
                    description:
            ...
            services: [
                {
                    ...
                    description:
                        'Покажите объект инвестору до выезда. Виртуальный тур заменяет первичный осмотр и приводит на встречу уже заинтересованного покупателя.',
                ...
                },
                {
                    ...
                    slug: 'tury-360-oteli',
                    title: '360° туры для отелей',
                    category: 'Отельер · Глэмпинг · Заполняемость.',
                    description:
                        'Гость принимает решение онлайн — ещё до звонка. Виртуальная прогулка по лобби, территории и номерному фонду увеличивает долю прямых продаж через ваш сайт.',
                    price: 'Бронирование · Инфраструктура · Туризм',
                ...
                },
                {
                    ...
                    category: 'HoReCa · Банкетный зал.',
                    description:
                        'Гость выбирает стол ещё до визита. Детальный обзор зала и декора работает как круглосуточный менеджер по продажам.',
                    price: 'Интерьер · Атмосфера · Мероприятие',
                    image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200&q=80',
                    primaryHref: '/360-tour-restaurants',
                },
                {
                    ...
                    title: '360° туры для автобизнеса',
                    category: 'Дилер · Авторитейл · Тест-драйв',
                    description:
                        'Покупатель изучает салон и экстерьер машины до визита. Виртуальный формат сокращает цикл сделки и приводит на встречу уже теплого клиента.',
                    price: 'Автосалон · Шоурум · Экстерьер',
                    image: 'https://images.unsplash.com/photo-1542282088-fe8426682b8f?w=1200&q=80',
                    primaryHref: '/360-tour-auto',
                },
                {
                    ...
                    title: '360° туры для туризма и локаций',
                    category: 'Турагент · Гид · Экскурсовод',
                    description:
                        'Покажите природу, архитектуру и атмосферу региона так, чтобы клиент выбрал именно ваш маршрут — ещё до первого звонка.',
                    price: 'Локация · Впечатления · Предвкушение',
                    image: 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=1200&q=80',
                    primaryHref: '/360-tour-tourism',
                },
                {
                ...
                },
                {
                    ...
                    category: 'Владелец · Управляющий · Франшиза',
                    description:
                        'Покажите пространство партнёрам и клиентам до встречи. Виртуальный формат усиливает доверие к компании и сокращает цикл принятия решения.',
                    price: 'Офис · Презентация · Репутация',
                    image: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=1200&q=80',
                    primaryHref: '/360-tour-business',
                },
            ],
