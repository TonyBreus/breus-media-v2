    ...
    droneService: {
        ...
        seo: {
            ...
            areaServed: [
                ...
                { '@type': 'AdministrativeArea', name: 'Ваке' },
                { '@type': 'AdministrativeArea', name: 'Сабуртало' },
                { '@type': 'AdministrativeArea', name: 'Диди Дигоми' },
                { '@type': 'AdministrativeArea', name: 'Старый Тбилиси' },
                { '@type': 'City', name: 'Батуми' },
                { '@type': 'City', name: 'Кутаиси' },
                { '@type': 'AdministrativeArea', name: 'Кахетия' },
            ],
        },
    },
    realEstateService: {
