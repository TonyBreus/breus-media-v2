...
- Re-architected header surface: returned transparent baseline with subtle 5% tint (`bg-black/[0.05]`) preserving background photo clarity on Hero, transitioning smoothly to delicate glass (`bg-black/35 backdrop-blur-md border-b border-white/10`) on scroll.
