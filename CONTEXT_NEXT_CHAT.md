...
- Re-architected header surface: 100% pure transparent on first load (`bg-transparent`), and precisely 20% tint (`bg-black/20 backdrop-blur-md border-b border-white/10`) for both the header and ticker when revealed on scroll.
